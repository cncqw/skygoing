...
Page({
    ...
    bindHeaderTap: function(t) {
      wx.showLoading({
        ...
        this.setData({
            ...
            scrollTop: 0,
            viewBox: !1
        }), e = 1, this.orderStatus(1, t.target.dataset.index), this.loadingChange();
    },
    orderStatus: function(o, i) {
        1 == (o = this).data.isListData && wx.request({
            ...
            success: function(t) {
              wx.hideLoading();
                for (var a = o.data.orders, i = 0; i < t.data.data.length; i++) {
                  // a.forEach(function(_a, _b){
                  //   console.log(_a, _b);
                  // });
                  // a.push(t.data.data[i]);
                }
                o.setData({
                    orders: t.data.data,
    ...
    onLoad: function(a) {
        ...
        }), e.orderStatus(1, e.data.current), e.loadingChange();
    },
